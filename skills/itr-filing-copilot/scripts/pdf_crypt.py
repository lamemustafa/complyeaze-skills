...
class PdfDecryptor:
    ...
    def _rejection(self) -> str:
        ...
        return ("password rejected. For documents the department issues — AIS, "
                ...
                "holder's own PAN MASKED, so it is the right shape and "
                "fails as a credential exactly the way a wrong date of "
                "birth does; a renamed or differently-issued file says "
                "nothing either way. Check "
